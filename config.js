...
window.HUB_CONFIG = {
  tenant: "momentum",
  seedVersion: "2026-08-26-momentum-v16-docs",
  ...
  departments: [
    { name:"",           keys:["home"] },
    { name:"Office",     keys:["calendar","connect","list","docs"], accent:"#0f9d9d" },
  ...
  sections: [
    { k:"home",     label:"Command Center",    ic:"/icons/command-center.svg", href:"/hub.html",      short:"Home", ds:"Everything you run, in one place" },
    { k:"calendar", label:"Calendar",           ic:"/icons/calendar.svg", href:"/calendar.html", short:"Calendar", ds:"Every class, team, party and closure \u2014 subscribe on your phone" },
    { k:"connect",  label:"Connect",            ic:"/icons/connect.svg", href:"/connect.html", short:"Connect", ds:"Message the staff, post to a channel, or get face to face \u2014 staff only" },
{ k:"list",     label:"Master List",        ic:"/icons/list.svg", href:"/list.html",   short:"List", ds:"The owners' running list \u2014 drag what matters most to the top" },
{ k:"docs",     label:"Documents",          ic:"/icons/docs.svg", href:"/docs.html",   short:"Docs", ds:"Letters, notices and flyers \u2014 written here, saved to Word with one button" },
    { k:"checkin",  label:"Check-in & Attendance", ic:"/icons/checkin.svg", href:"/checkin.html", short:"Check-in", ds:"One-tap front-desk check-in and the floor log" },
    { k:"enroll",   label:"Enrollment & Waitlists", ic:"/icons/enroll.svg", href:"/enroll.html", short:"Waitlist", ds:"Waitlist queues and one-click promotion" },
    { k:"funnel",   label:"Growth Funnel",     ic:"/icons/funnel.svg", href:"/funnel.html",   short:"Leads", ds:"Every lead from first click to enrolled" },
    { k:"schedule", label:"Classes & Schedule", ic:"/icons/schedule.svg", href:"/schedule.html", short:"Classes", ds:"Every class, roster and fill rate" },
    { k:"studio",   label:"Floor Studio",      ic:"/icons/studio.svg", href:"/studio.html",   short:"Floor", ds:"Rooms, rotations and the level ladders" },
    { k:"team",     label:"Team App",          ic:"/icons/team.svg", href:"/team.html",     short:"Team", ds:"Rosters, travel and team messages" },
    { k:"families", label:"Families & Kids",   ic:"/icons/families.svg", href:"/families.html", short:"Families", ds:"Every family, every kid, autopay status" },
    { k:"tuition",  label:"Tuition & Billing", ic:"/icons/tuition.svg", href:"/tuition.html",  short:"Tuition", ds:"Continuous enrollment, autopay the 1st" },
    { k:"books",    label:"Books & Margins",   ic:"/icons/books.svg", href:"/books.html",    short:"Books", ds:"Revenue, expenses and true margins" },
    { k:"payroll",  label:"Timesheets & Payroll", ic:"/icons/payroll.svg", href:"/payroll.html", short:"Payroll", ds:"Clocked hours \u2192 approved week \u2192 gross pay" },
    { k:"coaches",  label:"Staff & Coaches",   ic:"/icons/coaches.svg", href:"/coaches.html",  short:"Staff", ds:"Your team and their programs" },
    { k:"timeclock",label:"Time Clock",          ic:"/icons/timeclock.svg", href:"/timeclock.html", short:"Clock", ds:"Tap in, tap out \u2014 the front-desk clock" },
    { k:"hr",       label:"HR & Certifications", ic:"/icons/hr.svg", href:"/hr.html",     short:"Certs", ds:"Certs, expirations, payroll and onboarding" },
    { k:"law",      label:"Waivers & Safety",  ic:"/icons/law.svg", href:"/law.html",      short:"Safety", ds:"The waiver docket and the incident log" },
    { k:"approvals",label:"Approval Desk",     ic:"/icons/approvals.svg", href:"/approvals.html", short:"Approvals", ds:"Refunds, discounts and changes — owner signs" },
    { k:"comply",   label:"Comply · Trust Center", ic:"/icons/comply.svg", href:"/comply.html", short:"Trust", ds:"Live domain checks + sealed evidence chain" },
    { k:"it",       label:"System Health",     ic:"/icons/it.svg", href:"/it.html",       short:"Systems", ds:"Every system Momentum runs on, one board" },
    { k:"org",      label:"AI Staff",          ic:"/icons/org.svg", href:"/org.html",      short:"AI Staff", ds:"Frankie on duty — and the org that scales" },
    { k:"desk",     label:"The Desk Today",    ic:"/icons/desk.svg", href:"/desk.html",     short:"Desk", ds:"Who is here, who is late, who is waiting \u2014 right now" },
    { k:"pathway",  label:"Skill Pathways",    ic:"/icons/pathway.svg", href:"/pathway.html",  short:"Levels", ds:"Every level, and what each kid is working toward" },
    { k:"parties",  label:"Parties & Rooms",   ic:"/icons/parties.svg", href:"/parties.html", short:"Parties", ds:"Every booking against a room \u2014 no double-bookings" },
    { k:"bring",    label:"Bring Your Data",   ic:"/icons/bring.svg", href:"/import.html",   short:"Import", ds:"Your roster, imported in about a minute" },
    { k:"records",  label:"Hall of Records",   ic:"/icons/records.svg", href:"/records.html", short:"Records", ds:"Flyers, printouts and forms \u2014 kept, and private" },
    { k:"skins",    label:"Choose Your Look",  ic:"/icons/skins.svg", href:"/skins.html",    short:"Your Look", ds:"Six looks, made for Momentum — tap one, the whole hub repaints" }
  ],

  roles: {
    admin:     "*",
    manager:   "*",
    frontdesk: ["home","desk","checkin","enroll","funnel","schedule","pathway","team","families","parties","tuition","timeclock","records","calendar","connect","skins","docs"],
    coach:     ["home","desk","checkin","schedule","studio","pathway","team","coaches","hr","timeclock","records","calendar","connect"],
    trainee:   ["home","checkin","schedule","studio","pathway","timeclock","calendar","connect"],
    teacher:   ["home","checkin","schedule","studio","pathway","team","timeclock","records","calendar","connect"],
    parent:    ["home","team"],
    guest:     "*"
  },
  ...
  collections: ["classes","families","coaches","teams","teamevents","teammsgs","expenses","attendance","waitlist","leads","hrrecords","waivers","incidents","approvals","systems","evidence","kids","visits","offers","rooms","bookings","ladders","punches","payperiods","events","masterlist","documents"],
  ...
  seed: {
    ...
    documents: [],   // seeded EMPTY on purpose \u2014 the gym's papers are theirs to write
    events: [],
